          ...
          <div class="down clearfix">
            <form action="{{route('payments.alipay',['order'=>$order->orderid])}}" method="get">
              <table class="mylist" style="line-height: 30px">
                ...
                <tr style="display: none">
                  ...
                  <td class="td">
                    ...
                    <input type="text" style="width:300px;" class="txt" name="taobao" size="40"
                ...
                <tr style="display: none">
                  ...
                  <td class="td">
                    ...
                    <input type="text" name="daze" class="txt" placeholder="请输入8位折扣券密码，没有请留空" value=""
                           style="width:300px;"/>
              ...
              <a type="button" id="bottonsubmit" style="height:33px; margin-left:20px; margin-left:320px;"
                 href="{{ route('payments.alipay', ['order' => $order->id])}}"
                 class="btn btn-primary btn-sm sbtn">提交</a>
              <a type="button" id="btn-wechat" style="height:33px; margin-left:20px; margin-left:320px;display: none"
                 href="javascript:;"
                 class="btn btn-primary btn-sm sbtn">提交</a>
            </form>
