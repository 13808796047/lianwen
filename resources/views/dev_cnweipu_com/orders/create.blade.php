...
@section('content')
    <!-- Modal -->
<div class="modal fade text-center" id="staticBackdrop" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document" style="display:inline-block;width:auto;">
    <div class="modal-content" >
      <div class="modal-body" style="padding-bottom:0;">
        ...
        <p>提示：系统检测到您未添加微信提醒，请使用手机扫描以上二维码关注。</p>
