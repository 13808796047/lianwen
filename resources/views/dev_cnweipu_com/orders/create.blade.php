...
@section('content')
  <div class="p-4 mb-24">
    <div class="grid grid-cols-6 gap-4" >
      <div class="col-span-5 p-4" style="box-shadow: 0 0 6px rgba(0, 0, 0, 0.3);" style="background:#fff">
        <ul class=" category">
      ...
      <div class="col-span-1 p-4" style="box-shadow: 0 0 6px rgba(0, 0, 0, 0.3);" style="background:#fff">
        <b>1、检测结果是否准确？</b>
