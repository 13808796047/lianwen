...
@section('content')
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align:center;">
          <p>本次操作将消耗1次降重次数</p>
          <p>剩余次数：{{ auth()->user()->jc_times}}<span style="color:#4876FF;margin-left:10px;" id="addjctimes">增加次数</span>
          </p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align:center;">
          ...
          <p>请输入购买次数<span style="padding:0 10px;" id="cutjctime">-</span><span style="border: 1px solid;padding: 3px;"
                                                                               id="curjctime">1</span><span
              style="padding:0 10px;" id="addjctime">+</span></p>
        </div>
        <div class="modal-footer">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:0;text-align:center;">
          ...
          <div style="display:flex;justify-content: center;">
            <p id="demo" style="border: 1px solid;padding: 0 10px;">
              https://www.lianwen.com/zt/jc?uid={{auth()->user()->id}}</p>
  ...
  <div class="main clearfix" id="jcafter">
    <div class="lbox fl">
      ...
      <div style="display:flex;align-items: center;justify-content: space-between;">
        <p
          style="background-color: #4876FF;display: inline;padding: 5px 20px;color:#fff;text-align: center;font-size:15px;"
          id="reduce">
          一键降重</p>
        <p style="float: right;font-size: 13px;padding-right: 30px;" id="words">当前输入<span>0</span>字</p>
      </div>
      <div style="display: flex;justify-content: center;margin-top: 15px;">
        <p>剩余次数:<span id="jc_time">{{ auth()->user()->jc_times}}</span></p><span
          style="color:#4876FF;margin-left: 10px;" id="shopjctime">增加次数</span>
      </div>
    </div>
    <!--右边内容-->
  ...
  <div style="padding: 21px; display: none;min-height:800px;" id="jclater">
      ...
      <table style="width:100%;">
        <tr>
          <td style="width:48%;">
            ...
            <div
              style="height:650px;overflow-y:auto;background:#fff;border: 1px solid #ddd;padding: 19px;margin-right:5px;"
              id="content_after">
            </div>
          </td>
          <td style="width:48%;">
            ...
            <div
              style="height:650px;overflow-y:auto;background:#fff;border: 1px solid #ddd;padding: 19px;margin-left:5px;"
              id="content_later">
            </div>
          </td>
        </tr>
    ...
    <p
      style="background-color: #4876FF;padding: 5px 20px;color:#fff;text-align: center;margin:0 auto;width:100px;margin-top:16px;"
      id="againjc">
      再来一篇</p>
    <div style="display: flex;justify-content: center;margin-top: 15px;">
