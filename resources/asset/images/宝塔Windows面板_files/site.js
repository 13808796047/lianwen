...
var site = {
    ...
    edit: {
        ...
        set_en_script: function (siteName,name, status) {
            status = status ? 1 : 0;
            var loading = bt.load();
            bt.send("set_en_script", "site/set_en_script", { siteName:   siteName, name: name, status: status }, function (sdata) {
                loading.close();
                bt.msg(sdata);
            })           
        },
                ...
                bt.site.get_dir_userini(web.id, path, function (rdata) {
                    ...
                    var datas = [
                        ...
                        },
                        {
                            title: '', items: [
                                {
                                    name: 'en_asp', type: 'checkbox', text: '禁用Asp',value:rdata.asp, callback: function (sdata) {
                                        site.edit.set_en_script(web.name,'asp', sdata.en_asp)
                                    }
                                },
                                {
                                    name: 'en_aspx', type: 'checkbox', text: '禁用Aspx', value: rdata.aspx, callback: function (sdata) {
                                        site.edit.set_en_script(web.name,'aspx', sdata.en_aspx)
                                    }
                                },
                                {
                                    name: 'en_php', type: 'checkbox', text: '禁用PHP', value: rdata.php, callback: function (sdata) {
                    ...
                    },
                    {
                        title: "Let's Encrypt", callback: function (robj) {
                            ...
                            bt.site.get_site_domains(web.id, function (ddata) {
                                ...
                                var _ul = $('<ul id="ymlist" class="domain-ul-list"><li style="cursor: pointer;"><input class="checkbox-text" type="checkbox" value="all">全选</li></ul>');
